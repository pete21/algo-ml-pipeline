...
def dynamic_features(df, parameters, scaler, col_close="close", col_high="high", col_low="low"):
    ...
    df.loc[:,'rsi_slope'] = talib.LINEARREG_SLOPE(df['rsi'], parameters['rsi_slope_period'])
    ...
    df.loc[:,'stochk_slope'] = talib.LINEARREG_SLOPE(df['stochk'], parameters['stochk_slope_period'])
    ...
    df.loc[:,'stochrsik_slope'] = talib.LINEARREG_SLOPE(df['stochrsik'], parameters['stochrsik_slope_period'])
...
dfc['gap_ema_slope'] = talib.LINEARREG_SLOPE(dfc['gap_ema'], 9)
fig, ax1 = plt.subplots(figsize=(12, 8))
...
dfc['displacement_ema_slope'] = talib.LINEARREG_SLOPE(dfc['displacement_ema'], 9)
fig, ax1 = plt.subplots(figsize=(12, 8))
