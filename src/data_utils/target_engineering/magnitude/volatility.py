...
def future_volatility(
    ...
    **kwargs
    ...
    if method == "close_to_close":
        vol = close_to_close_volatility(
            df_copy.shift(-window_size), window_size=window_size, **kwargs
        )
        ...
        raise ValueError(
            "Invalid method selected. Choose from ['close_to_close', 'parkinson', 'rogers_satchell', 'yang_zhang']."
        )
